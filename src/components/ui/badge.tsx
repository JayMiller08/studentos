...
const badgeVariants = cva(
  'inline-flex items-center justify-center rounded-full border px-2.5 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none transition-colors',
  {
    variants: {
      variant: {
        // primary-strong for the same reason as the button: this fill sits
        // behind a white label and the lighter accent misses 4.5:1 in dark mode.
        ...
        warning: 'border-transparent bg-warning/15 text-warning-foreground dark:bg-warning/20 dark:text-warning',
